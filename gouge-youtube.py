#Gouge:
# - Scan a webpage's HTTP Response body.
# - Finds all URLs/endpoints present in the webpage's HTTP response.
# - While parsing the URL's, if it comes across a 
    # - JS url while scanning the HTTP Response, 
    # - it then makes an HTTP call to that JS file too
    # - and finds hidden endpoints/URLs in it too!
# - Finally, gives us a list with all these endpoints.
